...
public class FormAddUpdateActivity extends AppCompatActivity
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_submit){
            ...
            /*
           If the field is still empty then display an error message
             */
            ...
            if (!isEmpty){
                ...
                /*
                If it is edit setresult is UPDATE, and if not then setresult is ADD
                 */
                if (isEdit){
    ...
    /*
    Confirm dialog before canceling or deleting the process
    close = 10
    delete = 20
     */
